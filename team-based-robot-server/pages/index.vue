    ...
    <section>
      <v-parallax src="img/hero.jpg" height="600">
        <v-layout
          ...
          <h1 class="white--text mb-2 display-1 text-xs-center">Team-Based Robot Framework</h1>
      ...
      <v-layout row wrap align-center>
        <v-flex xs12>
          <div class="white--text ml-3 text-xs-center">
            ...
            and <a class="white--text" href="https://github.com/narospol">Naros</a>
          </div>
        </v-flex>
      </v-layout>
    </v-footer>
